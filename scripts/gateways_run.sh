...
function status() {
    ...
    ps aux | grep -v grep | grep -E "im_svc_presence|im_svc_contact|im_svc_user|im_svc_message|im_gateway_http|im_gateway_ws"
    
    echo -e "\n${YELLOW}监听端口状态：${NC}"
    netstat -tunlp | grep -E "8080|8081|8082|8060|8061|8070|8071|8072|8073"
}

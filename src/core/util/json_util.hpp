...
class JsonUtil {
   public:
    ...
    static int16_t GetInt16(const Json::Value &json, const std::string &name, int16_t default_value = 0);
    static uint16_t GetUint16(const Json::Value &json, const std::string &name, uint16_t default_value = 0);
    static int8_t GetInt8(const Json::Value &json, const std::string &name, int8_t default_value = 0);
    static uint8_t GetUint8(const Json::Value &json, const std::string &name, uint8_t default_value = 0);

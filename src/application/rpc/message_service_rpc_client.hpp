...
namespace IM::app::rpc
{
    ...
    public:
        ...
        Result<IM::dto::MessagePage> LoadHistoryRecords(const uint64_t current_user_id,
                                                        const uint8_t talk_mode,
                                                        const uint64_t to_from_id,
                                                        const uint16_t msg_type, uint64_t cursor,
                                                        uint32_t limit) override;
        Result<std::vector<IM::dto::MessageRecord>> LoadForwardRecords(
        ...
        Result<IM::dto::MessageRecord> SendMessage(

...
namespace IM::app::rpc
{
    ...
    IM::RockResult::ptr ContactQueryServiceRpcClient::rockJsonRequest(const std::string &ip_port,
                                                                      uint32_t cmd,
    ...
    bool ContactQueryServiceRpcClient::parseContactDetails(const Json::Value &j,
    ...
    Result<IM::dto::ContactDetails> ContactQueryServiceRpcClient::GetContactDetail(
